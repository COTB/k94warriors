...
namespace K94Warriors.Controllers
{
    ...
    public partial class T4MVC_AccountController : K94Warriors.Controllers.AccountController
    {
        ...
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, K94Warriors.Models.LoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult Login(K94Warriors.Models.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, K94Warriors.Models.RegisterModel model);

        public override System.Web.Mvc.ActionResult Register(K94Warriors.Models.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, K94Warriors.Models.LocalPasswordModel model);

        public override System.Web.Mvc.ActionResult Manage(K94Warriors.Models.LocalPasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, K94Warriors.Models.RegisterExternalLoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(K94Warriors.Models.RegisterExternalLoginModel model, string returnUrl)
        {
