...
namespace K94Warriors.Controllers
{
    public partial class PrintController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Profile = "~/Views/Print/Profile.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PrintController : K94Warriors.Controllers.PrintController
    {
        public T4MVC_PrintController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ProfileOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id);
